...
if (@$Result == "CAPTURED") {
   ...
   // $insert_id = mysqli_insert_id();
    ...
    $insert1 = "INSERT INTO `transcation_master`( `transaction_code`, reference_no,`payment_mode`, `transaction_date`, `is_deleted`, `transaction_status`)"
            . " VALUES ('".@$PayTxnID."','$ReferenceNumber','".@$Paymode."','".date('Y-m-d h:i:s')."',0,'failed')";
    db_query($insert1);
}
