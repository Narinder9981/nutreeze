...
$webappname ='Manzelle';
$webappfromemail= 'no-reply@manzelleapp.com';
$returnurl='http://manzelleapp.com/manzelleapp/payment/success.php';
$merchanterrorurl='http://manzelleapp.com/manzelleapp/payment/error.php';
