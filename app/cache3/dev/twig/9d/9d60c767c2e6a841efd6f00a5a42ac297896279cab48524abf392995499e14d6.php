...
/* AdminBundle:Height:addheight.html.twig */
class __TwigTemplate_909f3f6b4979efbd2a0a1151b20a3dc21164ab349e5d0c66077aef6d3f07644c extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "AdminBundle:Height:addheight.html.twig"));

        $this->parent = $this->loadTemplate("@Admin/Layout/adminlayout.html.twig", "AdminBundle:Height:addheight.html.twig", 1);
...
\t\t\t\t\t<div class=\"box-header with-border\">
                        <h3 class=\"box-title\">Add / Update Height</h3>
                    </div>
\t\t\t\t\t<!-- end: box header -->
\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t";
                // line 64
                $context["action"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_height_saveheight");
                // line 65
                echo "\t\t\t\t\t\t\t\t\t";
                $context["reason"] = "";
                // line 66
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                            // line 72
                            $context["main_reason_id"] = $this->getAttribute($context["main_reason"], "main_height_id", []);
                            // line 73
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                            $context["reason"] = $this->getAttribute($context["main_reason"], "height", []);
                            // line 74
                            echo "\t\t\t\t\t\t\t\t\t\t\t";
                        }
                        // line 75
...
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"main_height_id\" value=\"";
                // line 80
...
";
    ...
    {
        return "AdminBundle:Height:addheight.html.twig";
    }
...
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t{% set action = path('admin_height_saveheight') %}
\t\t\t\t\t\t\t\t\t{% set reason = '' %}
\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t{% set main_reason_id = main_reason.main_height_id %}
\t\t\t\t\t\t\t\t\t\t\t\t{% set reason = main_reason.height %}
\t\t\t\t\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t\t\t\t{% endfor %}
\t\t\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"main_height_id\" value=\"{{ main_reason_id }}\">
...
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-10\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<input class=\"form-control\" name=\"height\" value=\"{{reason}}\" />
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t</div>
...
{% endblock %}", "AdminBundle:Height:addheight.html.twig", "/var/www/admin/src/AdminBundle/Resources/views/Height/addheight.html.twig");
    }
}
