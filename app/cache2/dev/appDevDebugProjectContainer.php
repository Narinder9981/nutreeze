...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'lifestyle', 'user' => 'appuser', 'password' => 'Admin@1234', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_3e4f7670fd94c6f1b3e38f2eceb448545bd5f6262b55e11ce4f1de347d2e0ee1');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('live_path', 'http://192.168.1.55/q8');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WSBundle/Resources/views'), 'WS');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3245f312852d4727c26904ce938022f3e63bc379');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('617fd6c15fec32.29972409')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'WSBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/WSBundle'),
                    'namespace' => 'WSBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'database_port' => 3306,
            'database_name' => 'lifestyle',
            'database_user' => 'appuser',
            'database_password' => 'Admin@1234',
            'upload_dir' => ($this->targetDirs[2].'/../bundles/design/uploads'),
            'absolute_path' => ($this->targetDirs[2].'/../'),
            'live_path' => 'http://anonadiet.com/admin/',
            'file_path' => '/bundles/design/uploads',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'localhost',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '3245f312852d4727c26904ce938022f3e63bc379',
            'locale' => 'en',
            ...
            'kernel.secret' => '3245f312852d4727c26904ce938022f3e63bc379',
