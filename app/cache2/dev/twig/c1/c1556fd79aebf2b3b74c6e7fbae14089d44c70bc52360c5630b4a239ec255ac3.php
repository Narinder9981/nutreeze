...
/* AdminBundle:Aboutus:index.html.twig */
class __TwigTemplate_23ee2aacc4b1a5aa0799d460698b0ccfae4c0c9857f4d2978672e7531b902d4e extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "AdminBundle:Aboutus:index.html.twig"));

        $this->parent = $this->loadTemplate("@Admin/Layout/adminlayout.html.twig", "AdminBundle:Aboutus:index.html.twig", 1);
...
\t\t\t\t\t<div class=\"box-header with-border\">
                        <h3 class=\"box-title\">Add / Update About Us</h3>
                    </div>
\t\t\t\t\t<!-- end: box header -->
\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t";
                // line 59
                $context["action"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_aboutus_saveabout");
                // line 60
                echo "\t\t\t\t\t\t\t\t\t";
                $context["description"] = "";
                // line 61
...
\t\t\t\t\t\t\t\t\t\t";
                    // line 65
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable($context["about_us"]);
                    foreach ($context['_seq'] as $context["_key"] => $context["about_us"]) {
                        // line 66
                        echo "\t\t\t\t\t\t\t\t\t\t\t";
                        if (($this->getAttribute($context["about_us"], "language_id", []) == $this->getAttribute($context["language"], "language_master_id", []))) {
                            // line 67
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t";
                            // line 68
                            $context["main_about_us_id"] = $this->getAttribute($context["about_us"], "main_about_us_id", []);
                            // line 69
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                            $context["description"] = $this->getAttribute($context["about_us"], "description", []);
                            // line 70
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                            $context["img"] = $this->getAttribute($context["about_us"], "img", []);
                            // line 71
                            echo "\t\t\t
\t\t\t\t\t\t\t\t\t\t\t";
                        }
                    ...
                    $_parent = $context['_parent'];
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['about_us'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
                    // line 74
                    echo "\t\t\t\t\t\t\t\t\t";
                }
...
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"main_about_us_id\" value=\"";
                // line 78
                echo twig_escape_filter($this->env, ($context["main_about_us_id"] ?? $this->getContext($context, "main_about_us_id")), "html", null, true);
                echo "\">
...
";
    ...
    {
        return "AdminBundle:Aboutus:index.html.twig";
    }
...
\t\t\t\t\t\t<!-- tab-content -->
\t\t\t\t\t\t<div class=\"tab-content\">
\t\t\t\t\t\t{% set main_about_us_id = 0 %}
\t\t\t\t\t\t\t{% for language in language_list %}
\t\t\t\t\t\t\t\t<div role=\"tabpanel\" class=\"tab-pane {% if loop.index == 1 %}active{% endif %}\" id=\"lan_{{ language.language_master_id }}\">
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t{% set action = path('admin_aboutus_saveabout') %}
\t\t\t\t\t\t\t\t\t{% set description = '' %}
\t\t\t\t\t\t\t\t\t{% set img = '' %}
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t{% if about_us is defined and about_us is not empty %}
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t{% for about_us in about_us %}
\t\t\t\t\t\t\t\t\t\t\t{% if about_us.language_id == language.language_master_id %}
\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t{% set main_about_us_id = about_us.main_about_us_id %}
\t\t\t\t\t\t\t\t\t\t\t\t{% set description = about_us.description %}
\t\t\t\t\t\t\t\t\t\t\t\t{% set img = about_us.img %}
\t\t\t
\t\t\t\t\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t\t\t\t{% endfor %}
\t\t\t\t\t\t\t\t\t{% endif %}
...
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"main_about_us_id\" value=\"{{ main_about_us_id }}\">
...
{% endblock %}", "AdminBundle:Aboutus:index.html.twig", "/var/www/admin/src/AdminBundle/Resources/views/Aboutus/index.html.twig");
    }
}
