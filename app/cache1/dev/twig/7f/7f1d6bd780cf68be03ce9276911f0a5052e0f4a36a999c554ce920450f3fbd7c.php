...
/* AdminBundle:Terms:index.html.twig */
class __TwigTemplate_d2b6d265b54eeb0bc3f1b9139f808a5f3847935dc3c7a3378b1b9c0e07b5b80e extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "AdminBundle:Terms:index.html.twig"));

        $this->parent = $this->loadTemplate("@Admin/Layout/adminlayout.html.twig", "AdminBundle:Terms:index.html.twig", 1);
...
\t\t\t\t\t<div class=\"box-header with-border\">
                        <h3 class=\"box-title\">Add / Update Terms and Condition</h3>
                    </div>
\t\t\t\t\t<!-- end: box header -->
\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t";
                // line 59
                $context["action"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_terms_saveterms");
                // line 60
                echo "\t\t\t\t\t\t\t\t\t";
                $context["description"] = "";
                // line 61
...
\t\t\t\t\t\t\t\t\t";
                // line 63
                if (((isset($context["terms"]) || array_key_exists("terms", $context)) &&  !twig_test_empty(($context["terms"] ?? $this->getContext($context, "terms"))))) {
                    // line 64
                    echo "\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t";
                    // line 65
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["terms_details"]) {
                        // line 66
                        echo "\t\t\t\t\t\t\t\t\t\t\t";
                        if (($this->getAttribute($context["terms_details"], "language_id", []) == $this->getAttribute($context["language"], "language_master_id", []))) {
                            // line 67
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t";
                            // line 68
                            $context["main_terms_id"] = $this->getAttribute($context["terms_details"], "main_terms_id", []);
                            // line 69
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                            $context["description"] = $this->getAttribute($context["terms_details"], "description", []);
                            // line 70
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t";
                            $context["img"] = $this->getAttribute($context["terms_details"], "img", []);
                            // line 71
                            echo "\t\t\t
\t\t\t\t\t\t\t\t\t\t\t";
                        }
                    ...
                    $_parent = $context['_parent'];
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['terms_details'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
                    // line 74
                    echo "\t\t\t\t\t\t\t\t\t";
                }
...
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"main_terms_id\" value=\"";
                // line 78
                echo twig_escape_filter($this->env, ($context["main_terms_id"] ?? $this->getContext($context, "main_terms_id")), "html", null, true);
                echo "\">
...
\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-2\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<label>Image </br>(Size : 722 * 430)</label>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-10\">
...
";
    ...
    {
        return "AdminBundle:Terms:index.html.twig";
    }
    ...
    {
        return array (  402 => 152,  396 => 151,  378 => 138,  371 => 133,  342 => 122,  337 => 120,  330 => 115,  322 => 111,  318 => 110,  310 => 105,  289 => 87,  278 => 79,  274 => 78,  267 => 76,  264 => 75,  261 => 74,  255 => 73,  251 => 71,  248 => 70,  245 => 69,  243 => 68,  240 => 67,  237 => 66,  233 => 65,  230 => 64,  228 => 63,  225 => 62,  222 => 61,  219 => 60,  217 => 59,  207 => 57,  189 => 56,  187 => 55,  180 => 50,  177 => 49,  158 => 46,  145 => 45,  127 => 44,  125 => 43,  121 => 41,  119 => 40,  104 => 27,  95 => 24,  91 => 22,  86 => 21,  77 => 18,  73 => 16,  69 => 15,  62 => 11,  52 => 3,  46 => 2,  30 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t{% set action = path('admin_terms_saveterms') %}
\t\t\t\t\t\t\t\t\t{% set description = '' %}
\t\t\t\t\t\t\t\t\t{% set img = '' %}
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t{% if terms is defined and terms is not empty %}
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t{% for terms_details in terms %}
\t\t\t\t\t\t\t\t\t\t\t{% if terms_details.language_id == language.language_master_id %}
\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t{% set main_terms_id = terms_details.main_terms_id %}
\t\t\t\t\t\t\t\t\t\t\t\t{% set description = terms_details.description %}
\t\t\t\t\t\t\t\t\t\t\t\t{% set img = terms_details.img %}
\t\t\t
\t\t\t\t\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t\t\t\t{% endfor %}
\t\t\t\t\t\t\t\t\t{% endif %}
...
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"main_terms_id\" value=\"{{ main_terms_id }}\">
...
{% endblock %}", "AdminBundle:Terms:index.html.twig", "/var/www/admin/src/AdminBundle/Resources/views/Terms/index.html.twig");
    }
}
