...
/**
* @ORM\Entity
* @ORM\Table(name="freeze_subpackage")
*/
class Freezesubpackage
{
	/**
	...
	*/
	protected $freeze_subpackage_id;
	...
	*/
	...
	public function getFreeze_subpackage_id()
	{
		return $this->freeze_subpackage_id;
	}
