...
class WSWhyusController extends WSBaseController
{

	/**
   * @Route("/ws/whyus/{param}",defaults = {"param"=""},requirements={"param"=".+"})
   * @Template()
   */
  public function whyusAction($param) {
      try {
          ...
          if($this->validateData($param))
          {
                  ...
                  $get_tc	=	$this->getDoctrine()->getManager()
          								->getRepository("AdminBundle:Whyus")
