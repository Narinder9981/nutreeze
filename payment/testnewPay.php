 ...
 <div class="container-fluid">
  <div class="row">
   <div class="col-md-6 col-sm-6 col-xs-12 text-center">
    ...
    <br>
	<br>
	<a href="index.php"><button type="button" id=""  class="btn btn-success">Click here to Test Payment Link</button></a>
  </div>
<div class="col-md-6 col-sm-6 col-xs-12 text-center">
    <?php
if(isset($_POST['SubmitButton'])){
    ...
    //  echo $access_token;
      ...
      if(isset($json['access_token']) && !empty($json['access_token']))
      {
        ...
        $post_string = '{
           ...
           "CallBackUrl":  "http://i-managed.biz/muscle_fuel_v1/payment/testnewPay.php",
            "Language": 2,
             "ExpireDate": "2022-12-31T13:30:17.812Z",
  "ApiCustomFileds": "weight=10,size=L,lenght=170",
  "ErrorUrl": "http://i-managed.biz/muscle_fuel_v1/payment/testnewPay.php"
          }';
        $soap_do     = curl_init();
  ...
  Comments : '.$getRecorById['Comments'].'</label><br>';
    echo'<div class="form-group "><label class="control-label" for="name">
  Additional Data : '.$getRecorById['additionalData'].'</label><br>';
  echo'<div class="form-group "><label class="control-label" for="name">
